...
namespace Assignment3.Models
{
    public class Person
    {
        ...
        [NotNull,Range(0,9000000)] public int MonthlySalary { get; set; }
        [NotNull] [ValidHairColor] public string HairColor { get; set; }
        [ValidEyeColor] public string EyeColor { get; set; }

        [NotNull, Range(1, 250)] public int Age { get; set; }
        [NotNull, Range(1, 250)] public float Weight { get; set; }
        [NotNull, Range(1, 250)] public int Height { get; set; }
